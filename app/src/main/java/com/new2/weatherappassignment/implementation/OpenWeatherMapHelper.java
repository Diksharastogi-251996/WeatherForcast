package com.new2.weatherappassignment.implementation;
...
import com.new2.weatherappassignment.implementation.callback.ThreeHourForecastCallback;
import com.new2.weatherappassignment.model.threehourforecast.ThreeHourForecast;
import com.new2.weatherappassignment.network.OpenWeatherMapService;
import com.new2.weatherappassignment.network.Openweathermap;
...
public class OpenWeatherMapHelper {
    ...
    public OpenWeatherMapHelper(String apiKey){
        openWeatherMapService = Openweathermap.getClient().create(OpenWeatherMapService.class);
        options = new HashMap<>();
